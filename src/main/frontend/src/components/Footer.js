  ...
  return (
    <div>
      <footer>
        <div className="footer_info">
          ...
          <div className="subfooter_info">
            ...
            <div className="info_etc">
              ...
              <br /> 개인정보보호책임자: WeB(위비) | 이메일: hf23@gmail.com |
        ...
        (주)동덕 We B 사업자 정보 <img src={arrow} width="15px" />
          </p>
          {toggle3 == true && (
            <ul>
              <li>대표자: Gwang Lee | 사업자 번호 : 000-0000-0000</li>
              <li>개인정보보호책임자: WeB(위비) | 이메일: hf23@gmail.com </li>
